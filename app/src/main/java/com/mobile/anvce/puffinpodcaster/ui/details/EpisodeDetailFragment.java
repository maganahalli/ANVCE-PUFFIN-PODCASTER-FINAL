...
public class EpisodeDetailFragment extends Fragment implements Player.EventListener, PodcastConstatnts {

	private final static String TAG = EpisodeDetailFragment.class.getSimpleName();
	private FragmentEpisodeDetailBinding binding;
	private Episode episodeItem;
	...
	private EpisodeDetailViewModel detailViewModel;
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		detailViewModel = ViewModelProviders.of(this).get(EpisodeDetailViewModel.class);
		binding.addToFavoriteButton.setOnClickListener(new OnClickListener() {
			@Override
		...
		binding.playLaterSubmitButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				saveToPlayLaterList();
			}
	...
	private void saveToPlayLaterList() {
		detailViewModel.saveEpisodeToPlayLaterList(episodeItem);
	}

	private void saveToFavoriteList() {
		detailViewModel.saveEpisodeToFavoriteList(episodeItem);
	}
	...
	private void considerExtractingSearchItem() {
		...
		if (intent != null && intent.hasExtra(EPISODE_ITEM_KEY)) {
			episodeItem = intent.getParcelableExtra(EPISODE_ITEM_KEY);
			binding.setEpisodeItem(episodeItem);
		}
	}
	...
	public void onResume() {
		...
		if (TextUtils.isEmpty(episodeItem.getAudio())) {
			// do nothing
		}

		initFullscreenDialog();
		final Uri audioUri = Uri.parse(episodeItem.getAudio());
	...
	private void showNotification(PlaybackStateCompat state) {
		...
		builder.setContentTitle(episodeItem.getTitle())
	...
	public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
		if ((playbackState == ExoPlayer.STATE_READY) && playWhenReady) {
			...
			Log.d(TAG, "You Clicked on play button");
			detailViewModel.saveEpisodeToListeningHitory(episodeItem);
