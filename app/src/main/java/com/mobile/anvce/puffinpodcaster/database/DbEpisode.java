...
public class DbEpisode {
	...
	public DbEpisode(int id, String episodeId, String audio, String image, String title, String thumbnail, String description, Long pubDateMs, String listennotesUrl, Integer audioLengthSec, Boolean explicitContent, Boolean maybeAudioInvalid, String listennotesEditUrl, String category) {
		this.id = id;
