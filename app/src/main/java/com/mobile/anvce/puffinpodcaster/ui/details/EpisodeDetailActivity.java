...
public class EpisodeDetailActivity extends BaseNavigationActivity implements PodcastConstatnts {
	...
	private void setupNavigationView() {
		...
		AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
				R.id.navigation_explore, R.id.navigation_mypocasts, R.id.navigation_preferences, R.id.navigation_profile,R.id.navigation_episodes,R.id.navigation_episode_detail)
				.build();
